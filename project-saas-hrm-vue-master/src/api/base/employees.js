...
//export const importDown = data => createAPI(`/employees/export/${data.month}`, 'get', data) // 导出
...
//export const pdf = data => createAPI(`/employees/${data.id}/pdf`, 'get', data) // 打印pdf
export const pdf = data => createDown(`/employees/${data.id}/pdf`, 'get', data)